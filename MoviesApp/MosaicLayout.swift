...
class MosaicLayout: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        while currentIndex < count {
            let segmentFrame = CGRect(x: 0, y: lastFrame.maxY + 1.0, width: cvWidth, height: 300.0)
...
class MosaicLayout2: UICollectionViewLayout {
    ...
    override func prepare() {
        ...
        var currentIndex = 0
        var segment: MosaicSegmentStyle2 = .fiftyFifty
        var lastFrame: CGRect = .zero
        ...
        while currentIndex < count {
            ...
            case 1: segment = .fiftyFifty
            default: segment = .fiftyFifty
